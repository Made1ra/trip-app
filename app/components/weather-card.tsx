      ...
      <div className="flex flex-col items-start justify-center w-[30rem] h-[50rem] bg-indigo-950">
        ...
        <div className="flex flex-row p-4 items-center self-center mr-16">
          ...
          <div className="flex flex-row text-6xl font-bold text-white text-center">
            <p>{Math.round(temp)}</p>
            <sup className="font-thin text-xl">°C</sup>
          </div>
        </div>
        <p className="mb-4 self-center text-xl text-white">{city}</p>
        <div className="mt-20 flex flex-row self-center">
          <div className="flex-col text-white uppercase m-4">
            ...
            <p className="mt-2 text-base font-light uppercase">DAYS</p>
          </div>
          <div className="flex-col text-white uppercase m-4">
            <p className="text-2xl font-bold text-center">{hours}</p>
            <p className="mt-2 text-base font-light uppercase">HOURS</p>
          </div>
          <div className="flex-col text-white uppercase m-4">
            <p className="text-2xl font-bold text-center">{minutes}</p>
            <p className="mt-2 text-base font-light uppercase">MINUTES</p>
          </div>
          <div className="flex-col text-white uppercase m-4">
            <p className="text-2xl font-bold text-center">{seconds}</p>
            <p className="mt-2 text-base font-light uppercase">SECONDS</p>
          </div>
        </div>
      </div>
    </div>
